...
do
    ...
    do
        ...
        pid=$!            
        sleep 5
        timeout -k 10 5m python3 /home/henry/bigss/catkin_ws/src/bigss_spine/spine_python/ambf_highlevel_ipcai2022_script.py -t /home/henry/bigss/catkin_ws/src/bigss_spine/spine_robot_control/config/sim_ur5/points.txt -o $outdir -e $cam -s $slice --no-stamp 
        kill $pid
        pkill -f "AMBF" -9
        sleep 5
    done
